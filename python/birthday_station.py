...
frank_birthdate = 26
adrain_birthdate = 30
rotation = frank_birthdate/adrain_birthdate
drag = False
    ...
    def down():
        ...
        def set_v():
            ...
            if station is station1:
                vector2.axis.x -= scale_factor * v0
            else:
                vector2.axis.x += scale_factor * v0
        ...
        def up():
            ...
            if station is station1:
                v = vector1.axis / scale_factor
            else:
                v = vector2.axis / scale_factor
            go_tv = True

        s.bind("mouse_move", move)
        s.bind("mouse_up", up)

    s.bind("mouse_down", down)
...
scale_factor = 5 / (omega * station1.R)
