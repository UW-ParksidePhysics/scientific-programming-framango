...
def annotate_graph(chemical_symbol, crystal_symmetry):
    ...
    plt.text(0, -100, "created by Frank Lauerman 2022/05/11")
...
plt.text(-9.5, -1.75, "Created by Frank Lauerman 2022/05/11")
plt.title("Select Wavefunctions for a Harmonic Potential on a Spatial Grid of 0, 1, 2 Points")

if display_graph:
    plt.show()
elif not display_graph:
    plt.savefig("Lauerman.harmonic.Eigenvector0, 1, 2.png")
